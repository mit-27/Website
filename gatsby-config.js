const siteMetadata = {
  ...
  aboutme : `Hello !! My name is Mit Suthar. Currently, I am pursuing my B.Tech in Computer Engineering from the Computer Engineering Department of Chandubhai S Patel Institute of Technology, CHARUSAT, Anand with overall Distinction.
  I am an Android App Developer and Web developer. I love to build new stuff. I had worked with C, Python, PHP, C++, Java, C#.Net, JavaScript, jQuery, ReactJS, GatsbyJS, and Unity. I've built web and mobile apps. My goal is to secure a position where I can efficiently contribute my skills and abilities to the growth of the organization and build my professional career.
  `,
  author: `@Meetu_27`,
